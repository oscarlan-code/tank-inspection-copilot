package ai.laiq.tankinspection.presentation.v2product.utsetup
...
private fun V2UtSetup.isTargetSelected(target: V2LayoutTarget): Boolean =
    when (target) {
...
private fun V2UtSetup.withTargetSelected(
...
private fun V2LayoutTarget.utDetailLabel(): String =
    when (this) {
        V2LayoutTarget.EXTERNAL_ROOF -> "Approved external roof layout map."
        V2LayoutTarget.INTERNAL_ROOF -> "Approved internal roof layout map."
        V2LayoutTarget.SHELL -> "Approved shell layout map."
        V2LayoutTarget.FLOOR -> "Approved floor layout map."
    }
