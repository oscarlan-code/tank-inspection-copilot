package ai.laiq.tankinspection.presentation.v3product.generalinfo
...
@Composable
fun ProductGeneralTankInformationScreen(
    state: ProductGeneralTankInfo,
    onStateChange: (ProductGeneralTankInfo) -> Unit,
    onBack: () -> Unit,
    onContinue: () -> Unit,
