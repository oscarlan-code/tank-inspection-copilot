package ai.laiq.tankinspection.v2product.layoutsetup
...
import ai.laiq.tankinspection.v2product.model.withReconciledLayoutMapSetup
...
class V2LayoutMapSetupPreviewActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        V2PreviewSession.setActiveWorkflowScreen(V2WorkflowScreen.LAYOUT_MAP_SETUP)
