...
Android V3 Product source of truth reviewed:
...
- Use `apps/report-platform/src/fixtures/v3-product-export-shell-internal.json` as the app-import mock source for the report platform.
- Treat this fixture as Android V3 Product exported/captured data, not report-side hand-written mock content.
...
- The report platform should load it through `GET /api/v1/report-jobs/bootstrap/v10-api-standard` or accept it through `POST /api/v1/imports/android-v3-product`.

## Summary

| Area | App V3 Product seed/export | Report data | Status | Notes |
| --- | ---: | ---: | --- | --- |
...
| Report-platform fixture | 136 UT rows / 195 checklist rows | Full V10 app export | Aligned | Fixture now uses the report-aligned Android V3 Product data. |
