...
try{const pilot=createBaselineVariationPilot({db,objectStorage:createS3ObjectStorage()});console.log(JSON.stringify(await pilot.buildHiddenTestPilot({sampleSize:20,seed:1}),null,2));}finally{await db.close();}
