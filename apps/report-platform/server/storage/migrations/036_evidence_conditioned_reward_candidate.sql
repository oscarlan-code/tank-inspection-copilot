...
INSERT INTO system_rl_policy_versions (
  ...
  'rl_policy_report_generation_v6_evidence_reward','report_generation',6,'Evidence-conditioned reward candidate',
  'training','contextual_ucb_v1',0.25,90,0.72,0,
  '{"goldFirewall":true,"learningMode":"offline_only","rewardContract":"evidence_conditioned_v1","goldSimilarityRole":"diagnostic_only","retrievalIndex":"governed_kb_content_v1","pairContractVersion":2,"typedProtectedFactsOnly":true}'::jsonb,NOW()
...
SELECT replace(arm_id,'rl_arm_v5_','rl_arm_v6_'),'rl_policy_report_generation_v6_evidence_reward',arm_key,display_name,description,config_json,is_enabled,stable_order,NOW()
FROM system_rl_policy_arms WHERE policy_version_id='rl_policy_report_generation_v5_governed'
